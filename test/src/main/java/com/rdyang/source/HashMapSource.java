...
public class HashMapSource<K,V> extends AbstractMap<K,V>
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final void clear()               { HashMapSource.this.clear(); }
    ...
    static final class ValueSpliterator<K,V>
        ...
        ValueSpliterator(HashMapSource<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<K,V>
        ...
        EntrySpliterator(HashMapSource<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class TreeNode<K,V> extends LinkedHashMap.Entry<K,V> {
         ...
         * this node.
         */
        final Node<K,V> untreeify(HashMapSource<K,V> map) {
         ...
         */
        final TreeNode<K,V> putTreeVal(HashMapSource<K,V> map, Node<K,V>[] tab,
                                       int h, K k, V v) {
            Class<?> kc = null;
         ...
         */
        final void removeTreeNode(HashMapSource<K,V> map, Node<K,V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(HashMapSource<K,V> map, Node<K,V>[] tab, int index, int bit) {
            TreeNode<K,V> b = this;
